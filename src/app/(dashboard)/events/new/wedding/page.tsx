  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <form className="space-y-6">
        ...
        <div className="rounded-xl border-2 border-amber-200 bg-amber-50 p-6 shadow-sm space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Budget Planning</h3>
              <p className="text-sm text-gray-600 mt-1">Optional - you can add this later</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                min="0"
                step="10000"
                className="w-full rounded-lg border border-gray-300 pl-8 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500"
                placeholder="2500000"
              />
            </div>
            <p className="text-xs text-gray-500 mt-1">
              Your estimated total wedding budget (can be updated anytime)
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="bride_family" className="block text-sm font-medium text-gray-700 mb-2">
                Bride's Family Name (Optional)
              </label>
              <input
                id="bride_family"
                name="bride_family"
            ...
            <div>
              <label htmlFor="groom_family" className="block text-sm font-medium text-gray-700 mb-2">
                Groom's Family Name (Optional)
              </label>
              <input
                id="groom_family"
                name="groom_family"
